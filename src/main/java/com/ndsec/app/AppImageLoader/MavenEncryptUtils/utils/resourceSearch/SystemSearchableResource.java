 ...
 */
public class SystemSearchableResource extends SearchableResource implements ISearchableResource {
    ...
    public File getFile(String resourcePath) {
        if (!canReadAsFile()) {
            throw new IllegalStateException(getCanNotRepresentedAsFileExceptionMsg());
        }

        ClassLoader appClassLoader =
                this.getClass()
                    .getClassLoader();
        URL resource = appClassLoader.getResource(resourcePath);
